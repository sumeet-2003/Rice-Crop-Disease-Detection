...
def predict():
    ...
    predicted_percentage = round(prediction[0][predicted_class_index] * 100, 2)

    # Return the prediction result
    return render_template('index.html', predicted_class=predicted_class, predicted_percentage=predicted_percentage)
